...
@productos_bp.route("/productos/<int:codigo>", methods=["GET"])
...
@productos_bp.route("/productos/<int:codigo>", methods=["PUT"])
...
@productos_bp.route("/productos/<int:codigo>", methods=["DELETE"])
